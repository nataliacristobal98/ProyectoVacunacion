...
$date = strtotime("+21 day", strtotime($_SESSION["fecha_vacunacion"]));
...
<head>
    ...
    <title>Vacunación COVID - Segunda dosis</title>
...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <main role="main" class="inner cover">
        <h2 class="cover-heading"><b><b><?php echo htmlspecialchars($_COOKIE['APELLIDO']); ?></b>, ya está registrado para sus dosis.</h2>
        ...
        <ul>
            ...
            <li>La fecha de tu primera dosis es el <b><?php echo htmlspecialchars(date("d-m-Y", $fecha)); ?></b>,
                a las <b><?php echo htmlspecialchars($hora); ?></b>:<b><?php echo htmlspecialchars($min); ?></b>. <br>
                Por lo tanto tu segunda dosis será el <b><?php echo htmlspecialchars(date("d-m-Y", $date)) ?></b> a la misma hora.</li>
        </ul>
    </main>
    </br>
